...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2025 at 03:17 PM
...
(44, 'Tommy', 'Jones', 'eoin.murphy@hotmail.com', 'bjpass', '13 Talbot Street', '+353 1 234 5678', '1985-03-12', 'Paypal', 'Large', 'Silver', 'SMS', '2023-02-23', 'Dublin'),
...
(1, 'This database is proprietary. Do not use or distribute without permission from alan.ryan@tus.ie', '2025-10-18 09:08:23'),
(2, 'This database is intended solely for use by students enrolled in the B.Sc. in Software Development (Year 3) and the B.Sc. In Mobile and Web Development (Year 3) for the purpose of coursework related to Applications Programming and Concurrent Programming.', '2025-10-18 12:51:19');
...
CREATE TABLE `wishlist` (
  ...
  `last_seen_price` decimal(10,2) DEFAULT NULL,
  `last_seen_available` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `wishlist` (`wishlist_id`, `customer_id`, `product_id`, `added_date`, `wishlist_name`, `notes`, `notify_back_in_stock`, `notify_price_drop`, `last_seen_price`, `last_seen_available`) VALUES
(1, 33, 12, '2023-10-11', 'Lauras Xmas Present List', 'Make sure to check the sizes for Dad', 0, 0, NULL, NULL),
(2, 67, 28, '2023-10-12', 'Dylans List', NULL, 0, 0, NULL, NULL),
(3, 102, 41, '2023-10-13', NULL, NULL, 0, 0, NULL, NULL),
(4, 9, 1, '2023-10-14', NULL, NULL, 0, 0, NULL, NULL),
(5, 79, 17, '2023-10-15', 'Sorchas', NULL, 0, 0, NULL, NULL),
(6, 44, 45, '2023-10-16', NULL, NULL, 0, 0, NULL, NULL),
(7, 125, 2, '2023-10-17', NULL, NULL, 0, 0, NULL, NULL),
(8, 28, 53, '2023-10-18', 'Michaels', NULL, 0, 0, NULL, NULL),
(9, 147, 37, '2023-10-19', NULL, NULL, 0, 0, NULL, NULL),
(10, 57, 7, '2023-10-20', NULL, NULL, 0, 0, NULL, NULL),
(11, 33, 23, '2023-10-21', NULL, NULL, 0, 0, NULL, NULL),
(12, 84, 34, '2023-10-22', NULL, NULL, 0, 0, NULL, NULL),
(13, 139, 16, '2023-10-23', NULL, NULL, 0, 0, NULL, NULL),
(14, 8, 49, '2023-10-24', NULL, NULL, 0, 0, NULL, NULL),
(15, 101, 42, '2023-10-25', NULL, NULL, 0, 0, NULL, NULL),
(16, 150, 20, '2023-10-26', NULL, NULL, 0, 0, NULL, NULL),
(17, 33, 30, '2023-10-27', 'Lauras Xmas List', NULL, 0, 0, NULL, NULL),
(18, 23, 11, '2023-10-28', 'Sile\'s List', NULL, 0, 0, NULL, NULL),
(19, 76, 8, '2023-10-29', NULL, NULL, 0, 0, NULL, NULL),
(20, 68, 3, '2023-10-30', NULL, NULL, 0, 0, NULL, NULL),
(21, 10, 26, '2023-11-01', NULL, NULL, 0, 0, NULL, NULL),
(22, 119, 56, '2023-11-02', NULL, NULL, 0, 0, NULL, NULL),
(23, 17, 14, '2023-11-03', NULL, NULL, 0, 0, NULL, NULL),
(24, 87, 31, '2023-11-04', NULL, NULL, 0, 0, NULL, NULL),
(25, 51, 35, '2023-11-05', NULL, NULL, 0, 0, NULL, NULL),
(26, 73, 9, '2023-11-06', NULL, NULL, 0, 0, NULL, NULL),
(27, 25, 19, '2023-11-07', NULL, NULL, 0, 0, NULL, NULL),
(28, 132, 24, '2023-11-08', NULL, NULL, 0, 0, NULL, NULL),
(29, 45, 46, '2023-11-09', NULL, NULL, 0, 0, NULL, NULL),
(30, 94, 4, '2023-11-10', NULL, NULL, 0, 0, NULL, NULL),
(31, 39, 18, '2023-11-11', NULL, NULL, 0, 0, NULL, NULL),
(32, 61, 43, '2023-11-12', NULL, NULL, 0, 0, NULL, NULL),
(33, 3, 2, '2023-11-13', NULL, NULL, 0, 0, NULL, NULL),
(34, 129, 38, '2023-11-14', NULL, NULL, 0, 0, NULL, NULL),
(35, 65, 21, '2023-11-15', NULL, NULL, 0, 0, NULL, NULL),
(36, 13, 51, '2023-11-16', NULL, NULL, 0, 0, NULL, NULL),
(37, 146, 29, '2023-11-17', NULL, NULL, 0, 0, NULL, NULL),
(38, 19, 37, '2023-11-18', NULL, NULL, 0, 0, NULL, NULL),
(39, 2, 53, '2024-02-27', 'Aoifes Christmas List 2024', 'Need to start putting money away for Christmas!!', 0, 0, NULL, NULL),
(57, 1, 2, NULL, NULL, NULL, 0, 0, 69.99, 70),
(59, 1, 1, NULL, NULL, NULL, 0, 0, 25.99, -5),
(60, 1, 13, NULL, NULL, NULL, 0, 0, 54.99, 105),
(61, 1, 6, NULL, NULL, NULL, 0, 0, 16.99, -1);
...
ALTER TABLE `alerts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_alert_customer` (`customer_id`),
...
--
ALTER TABLE `alerts`
  ADD CONSTRAINT `fk_alert_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`),
